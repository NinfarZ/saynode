...
function App() {
  ...
  {
    key: "d1",
    url: "/data/equity_curve.csv",
    label: "Equity Curve",
    color: "#4BC0C0",
  },
  {
    key: "d2",
    url: "/data/equity_curve_ar_56_tp_sl.csv",
    label: "Equity Curve AR 56 TP SL",
    color: "#9966FF",
  },
  {
    key: "d3",
    url: "/data/equity_curve_ar_only.csv",
    label: "Equity Curve AR Only",
    color: "#FF9F40",
  },
  {
    key: "d4",
    url: "/data/equity_curve_ar_raw.csv",
    label: "Equity Curve AR Raw",
    color: "#FFCD56",
  },
  {
    key: "d5",
    url: "/data/equity_curve_backtest_2.csv",
    label: "Backtest 2",
    color: "#36A2EB",
  },
  {
    key: "d6",
    url: "/data/equity_curve_backtest_3_improved.csv",
    label: "Backtest 3 Improved",
    color: "#FF6384",
  },
  {
    key: "d7",
    url: "/data/equity_curve_backtest_3_sensor_chop_mode.csv",
    label: "Sensor Chop Mode",
    color: "#C9CBcf",
  },
  {
    key: "d8",
    url: "/data/equity_curve_backtest_3.csv",
    label: "Backtest 3",
    color: "#000000",
  },
];
